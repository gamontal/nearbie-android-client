...
public class MainActivity extends AppCompatActivity {
    ...
    private void buildBottomBar(Bundle savedInstanceState) {
        ...
        mBottomBar.setItems(
                new BottomBarTab(R.drawable.ic_near_me_black_24dp, R.string.main_tab_spots),
                new BottomBarTab(R.drawable.ic_chat_bubble_black_24dp, R.string.main_tab_chat),
                new BottomBarTab(R.drawable.ic_public_black_24dp, R.string.main_tab_trending),
                new BottomBarTab(R.drawable.ic_settings_black_24dp, R.string.main_tab_settings));
